...
export default function DeleteAll() {
    ...
    const handleDelete = async (withTruncate: boolean) => {
        ...
        try {
            await axios.delete("/api/tags/delete-all", {
                data: {
            ...
            toast.success(
                withTruncate
                    ? "Всички тагове бяха изтрити (TRUNCATE)"
                    : "Всички тагове бяха изтрити",
            );
            ...
            <AlertDialogContent>
                <AlertDialogHeader className="mb-5">
                    ...
                    <div className="space-y-5">
                        <p>
                            Това действие ще{" "}
                            <strong>премахне всички тагове</strong> от
                            системата.
                        </p>

                        <p>
                            След изтриването таговете{" "}
