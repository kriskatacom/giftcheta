...
export default function DeleteAll() {
    ...
    const handleDelete = async (withTruncate: boolean) => {
        ...
        try {
            await axios.delete("/api/colors/delete-all", {
                data: {
            ...
            toast.success(
                withTruncate
                    ? "Всички цветове бяха изтрити (TRUNCATE)"
                    : "Всички цветове бяха изтрити",
            );
            ...
            <AlertDialogContent>
                <AlertDialogHeader className="mb-5">
                    ...
                    <div className="space-y-5">
                        <p>
                            Това действие ще{" "}
                            <strong>премахне всички цветове</strong> от
                            системата.
                        </p>

                        <p>
                            След изтриването цветовете{" "}
