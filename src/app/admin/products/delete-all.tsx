...
export default function DeleteAll() {
    ...
    const handleDelete = async (withTruncate: boolean) => {
        ...
        try {
            ...
            toast.success(
                withTruncate
                    ? "Всички продукти бяха изтрити (TRUNCATE)"
                    : "Всички продукти бяха изтрити",
            );
            ...
            <AlertDialogContent>
                <AlertDialogHeader className="mb-5">
                    ...
                    <div className="space-y-5">
                        <p>
                            Това действие ще{" "}
                            <strong>премахне всички продукти</strong> от
                            системата.
                        </p>

                        <p>
                            След изтриването продуктите{" "}
