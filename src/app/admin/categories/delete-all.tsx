...
export default function DeleteAll() {
    ...
    const handleDelete = async (withTruncate: boolean) => {
        ...
        try {
            await axios.delete("/api/categories/delete-all", {
                data: {
            ...
            toast.success(
                withTruncate
                    ? "Всички категории бяха изтрити (TRUNCATE)"
                    : "Всички категории бяха изтрити",
            );
            ...
            <AlertDialogContent>
                <AlertDialogHeader className="mb-5">
                    ...
                    <div className="space-y-5">
                        <p>
                            Това действие ще{" "}
                            <strong>премахне всички категории</strong> от
                            системата.
                        </p>

                        <p>
                            След изтриването категориите{" "}
